...
│                    PRETRAINING                              │
├─────────────────────────────────────────────────────────────┤
│  FM_x (prior → q_x)     │     FM_y (prior → q_y)           │
│  ↓                      │     ↓                             │
│  u_t^x(x_t, t)          │     u_t^y(y_t, t)                │
└─────────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────────┐
│              INDEPENDENT FLOW (baseline)                    │
├─────────────────────────────────────────────────────────────┤
│  p_t^ind(x,y) = p_t^x(x) · p_t^y(y)                        │
│  v_t^ind(x,y) = [u_t^x(x,t), u_t^y(y,t)]                  │
└─────────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────────┐
│            RATIO ESTIMATION                                 │
├─────────────────────────────────────────────────────────────┤
│  r̂_1(x,y) = q(x,y) / p_1^ind(x,y)                         │
│  Method: Discriminator (default) + RuLSIF (optional)       │
└─────────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────────┐
│              GUIDED SAMPLING                                │
├─────────────────────────────────────────────────────────────┤
│  dz_t/dt = v_t^ind(z_t) + γ · ∇_{z_t} log r̂_t(z_t)       │
│  → Coherent pairs (x_1, y_1)                               │
└─────────────────────────────────────────────────────────────┘
```
...
@software{ratio_guided_fm_2025,
  ...
  author={Your Name},
  year={2025},
  url={https://github.com/yourusername/ratioGuidedFM}
}
```
